...
Public Partial Class IParserMock
        Implements IParser, IStunt, IMocked
        ...
        <CompilerGenerated>
        Public Function TryParse(input As String, <Out> ByRef result As DateTimeOffset) As Boolean Implements IParser.TryParse
            Dim returns As IMethodReturn = pipeline.Execute(New MethodInvocation(Me, MethodBase.GetCurrentMethod(), input, result))
            result = DirectCast(returns.Outputs("result"), DateTimeOffset)
