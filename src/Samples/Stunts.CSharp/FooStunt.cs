...
namespace Stunts.CSharp
{
    class FooStunt : CalculatorBase, IStunt, IDisposable, IServiceProvider
    {
        ...
        [CompilerGenerated]
        public object GetService(Type serviceType) => pipeline.Execute<object>(new MethodInvocation(this, MethodBase.GetCurrentMethod(), serviceType));
