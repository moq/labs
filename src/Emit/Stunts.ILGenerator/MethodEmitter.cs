...
namespace Moq.Proxy
{
    public class MethodEmitter
    {
        ...
        private static readonly MethodInfo interceptorInvokeMethod = Reflect.Method<IProxyInterceptor>(i => i.Invoke(null));
        ...
        public MethodEmitter(TypeBuilder typeBuilder, FieldBuilder interceptorField, IDictionary<Type, Type> genericMappings)
        {
        ...
        public static object GetCurrentMethod(Type type, MethodInfo methodInfo)
        {
            ...
            {
                return type.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).First(m => methodInfoComparer.Equals(m, methodInfo));
            }

            return type.GetMethod(methodInfo.Name, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, methodInfo.GetParameterTypes().ToArray(), null);
        }
        ...
        public sealed class InvokeBaseMarker
        {
