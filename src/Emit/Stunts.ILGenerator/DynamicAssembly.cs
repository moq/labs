...
namespace Moq.Proxy
{
	...
	{
		public const string AssemblyName = "<Mock#_Assembly>";
...
#if SILVERLIGHT
		private static byte[] GetStrongNameKeyPair()
		{
			using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Moq.Proxy.KeyPair.snk"))
			{
